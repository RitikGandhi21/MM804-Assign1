...
def CreateViewPort(reader,writeFileName,ROTATION_ANGLE_X=-90,ROTATION_ANGLE_Y=0,ROTATION_ANGLE_Z=0):
    ...
    render1.AddLight(light)
    render2.AddLight(light)
    # render3.AddLight(light)
    # render4.AddLight(light)
...
CreateViewPort(ROTATION_ANGLE_X=-90,ROTATION_ANGLE_Y=0,ROTATION_ANGLE_Z=0,reader=reader,writeFileName='angle1.png')
CreateViewPort(ROTATION_ANGLE_X=-90,ROTATION_ANGLE_Y=0,ROTATION_ANGLE_Z=90,reader=reader,writeFileName='angle2.png')
CreateViewPort(ROTATION_ANGLE_X=-90,ROTATION_ANGLE_Y=0,ROTATION_ANGLE_Z=180,reader=reader,writeFileName='angle3.png')
CreateViewPort(ROTATION_ANGLE_X=-90,ROTATION_ANGLE_Y=0,ROTATION_ANGLE_Z=270,reader=reader,writeFileName='angle4.png')

import vtk

# Load the STL file
reader = vtk.vtkSTLReader()
reader.SetFileName("goku_ss.stl")
reader.Update()
